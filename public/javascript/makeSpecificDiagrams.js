...
function drawHarmonic(harmonicNumber, end1, end2, amplitude, wavelength) {
    if (end1 === undefined) {
        end1 = 'closed';
    }
    if (end2 === undefined) {
    ...
    let newWave = new Wave(numWavelengths,amplitude,wavelength,phaseProportion);
    newWave.addSecondHalf(true);

    return newWave
}

/// i think that harmonics should be their own object!!!
/// not a function